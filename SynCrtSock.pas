...
{$endif FPC}
  ...
  public
    ...
    /// will concat the message with the supplied WSAGetLastError information
    constructor CreateFmt(const Msg: string; const Args: array of const; Error: integer; Dummy : integer = 0); overload;
  published
...
constructor ECrtSocket.CreateFmt(const Msg: string; const Args: array of const; Error: integer; Dummy : integer );
begin
  if Error<0 then
    Error := WSAGetLastError;
